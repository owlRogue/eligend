...
core.Node.prototype = {
	...
	set nodeName(name) { throw new core.DOMException();},
	get attributes() { return this._attributes;},
	get firstChild() {
		return this._childNodes.length > 0 ? this._childNodes[0] : null;
	},
	set firstChild(v) { throw new core.DOMException();},
	get ownerDocument() { return this._ownerDocument;},
	...
	set lastChild(v) { throw new core.DOMException();},

	get childNodes() {
		return this._childNodes;
	},
	set childNodes(v) { throw new core.DOMException();},
	...
	set nextSibling(v) { throw new core.DOMException();},
	...
	set previousSibling(v) { throw new core.DOMException();},
...
core.ProcessingInstruction.prototype = {
	...
	set data(v)   { throw new core.DOMException(NO_MODIFICATION_ALLOWED_ERR);},
	get attributes() { return null;}
...
core.Notation.prototype = {
	...
	set nodeValue(v) { /* intentionally left blank */ },
	get nodeValue() { return this._nodeValue;},
};
